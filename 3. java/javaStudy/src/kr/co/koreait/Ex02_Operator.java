...
public class Ex02_Operator {
	...
	public static void main(String[] args) {
		// 연산자 (Operator)
		// - 수학적 계산이나 데이터 처리를 수행하기 위해 사요하는 기호 또는 기호 조합
		...
		int y = 10;
		System.out.println("후위 연산자 : " + y++); // 10
		// y = y + 1;
		...
		System.out.println(str1.equals(str2)); // 문자열 비교아기 때문에 true
		                 // "ABC" == "ABC" 비교~~
		
		System.out.println("--------논리 부정 연산자---------");
		// 4. 논리 부정 연산자
		// - true면 false를 반환 하고 false면 true를 반환
		...
		// 5. 논리 연산자 
		// - 논리식으로 판단하며 참(true) 또는 거짓(false)반환
		
		// && : 두 피연산자가 모두 참 (true)일 때 true 반환
		// || : 두 피연산자가 중 하나라도 참( true)일 때 true 반환
		...
		// 6. 복합 대입 연산자
		// - 대입 연산자(=)와 산술 연산자 (+, -, *, /, %)를 함께 사용하는 기호 조합
		
		
		int sum = 0;
		sum += 10; // 기존 sum이라는 변수에 들어가는 값에 10 더하기 하고 저장함
