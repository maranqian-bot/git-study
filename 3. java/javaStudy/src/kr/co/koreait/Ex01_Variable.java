...
public class Ex01_Variable {
	...
	public static void main(String[] args) {
		...
		// < 자동 형변환 / 암시적 형변환)
		// - 개발자가 직접 형변환 해주지 않아도 컴파일 과정에서 자동으로 변환됨
		...
		// 실수형은 메모리 설계상 양수보다 더 넓은 범위를 사용하기 떄문에 가능
		long longNumber = 10000000000L;
		float floatNumber = longNumber;  //8byte -> 4byte
		System.out.println(floatNumber);
		
		// 강제 형변환 (명시적 형변환)
		// - 개발자가 직접 형변환을 작성 해줘야하며 하지 않는 경우 컴파일 에러 발생
		// - 범위가 큰 자료형 -> 범위가 잗은 자료형
		// - 주의 : 큰 자료형에서 작은 자료형으로 변환하기 때문에 데이커 손실 발생할 수 있음
		long INumber = 10000000000L;
		int iNumber = (int)INumber; //8byte를 강제로 4byte로 변경
		...
		int age2 = 19;
		String addr = "인천";
		System.out.printf("안녕하세요.%n 제 이름은 %s입니다.\n 나이는 %d 이고 사는곳은 %s에 살고 있습니다. ", name , age, addr);
		
		double pi_double = 3.14;
		System.out.printf("pi_double의 값은 %.3f 입니다", pi_double);
		...
		// 4. \문자 : 특수 문자를 일반 문자열로 인식해야할 때 사용
		 ...
		 System.out.println("\"Hello ,World!\""); // "Hello ,World!" 문자열로 출력하고 싶으면 <- 예시 봐 ㅋ
		 System.out.println("개행 문자는 \\n 입니다."); // \n 문자열로 출력하고 싶으면 앞에 \ 더 붙으면 됨
		 ...
		 // 3. 사용자 입력 받은 값 변수에 저장)
		 //     > String choice = sc.nextLine();
		 
		 
		 //마우스를 빨간줄 위에 올리고 import 하는 방법
		 // 또는 ctrl + shift + o를 눌러서 import 하는 방법
		 Scanner sc = new Scanner (System.in);
